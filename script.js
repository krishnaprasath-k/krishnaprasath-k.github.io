...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "              AI Developer • React • Python • Flutter\n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "AI Developer with 2+ years of experience building",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
...
${this.wrapWithColor(
  "   Building AI-powered mobile apps and scalable solutions using",
  "#ffffff"
)}
${this.wrapWithColor("   React Native, Python, and Flutter", "#ff8c00")}
...
<span style="color: #00ffff;">CLOUDMATEKAT ENTERPRISES | AI Developer</span>
${this.wrapWithColor(
  "April 2024 – Present | India",
  "#ffffff"
)}
${this.wrapWithColor(
  "AI-powered mobile and web platform development",
  "#98fb98"
)}

• ${this.wrapWithColor("Part of Core team", "#ffa07a")} - ${this.wrapWithColor(
      "Collaborated on product decisions and feature development.",
      "#ffffff"
    )}
• ${this.wrapWithColor(
      ...
      "Built an AI platform for a Flutter mobile application.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Performance Engineer", "#ffa07a")} - ${this.wrapWithColor(
      "Improved app performance and UX through code optimization.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Product Coordination", "#ffa07a")} - ${this.wrapWithColor(
      "Implemented features based on user feedback and product goals.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Flutter, Python, React, Firebase, Node.js, TensorFlow, REST APIs",
      "#87cefa"
    )}`;
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Foundation of my AI and software engineering journey ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "╰──────────────────────────────────────────────────╯",
...
• ${this.wrapWithColor("Expo", "#ffffff")}
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:work.krishnaprasath@gmail.com" style="color: #ffffff; text-decoration: none;">work.krishnaprasath@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://krishnaprasath-k.github.io" target="_blank" style="color: #ffffff; text-decoration: none;">krishnaprasath-k.github.io</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/krishnaprasath-k" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/krishnaprasath-k</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://www.linkedin.com/in/krishna-prasath-k-61445124a/" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/krishna-prasath-k-61445124a</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "krishna@prasath: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    url.textContent = "krishnaprasath-k.github.io";
